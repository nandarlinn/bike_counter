...
- **Model training + CVAT annotation (with tracking)**: See [`CVAT_ANNOTATIONS_AND_MODEL_TRAINING.md`](https://github.com/nandarlinn/bike_counter/blob/main/CVAT_ANNOTATIONS_AND_MODEL_TRAINING.md)
