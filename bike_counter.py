...
# # =========================
# LINE_A = ((350, 200), (600, 90))    # OUT only
# LINE_B = ((600, 200), (900, 200))     # IN only

# # Polygon gate for Line C (thin rectangle)
# POLY_C = np.array([
#     [500, 600],
#     [900, 600],
#     [900, 900],
...
#         # Polygon C (ENTER only)
#         if not t["counted_C"] and not prevInsideC and curInsideC:
#             count_C += 1
#             t["counted_C"] = True
...
#     cv2.putText(frame, f"Line A (OUT): {count_A}", (30,40), 0, 1, (255,0,0), 2)
#     cv2.putText(frame, f"Line B (IN): {count_B}", (30,80), 0, 1, (0,0,255), 2)
#     cv2.putText(frame, f"Gate C: {count_C}", (30,120), 0, 1, (0,255,255), 2)
...
# # LINES
# # =========================
# LINE_A = ((350, 200), (600, 90))    # IN only
# LINE_B = ((600, 200), (900, 200))    # OUT only
# LINE_C = ((500, 500), (700, 900))   # BOTH
...
#         prevA, prevB, prevC = t["sideA"], t["sideB"], t["sideC"]
#         curA = side_of_line(c, LINE_A)
#         curB = side_of_line(c, LINE_B)
#         curC = side_of_line(c, LINE_C)
...
#         # Line C → BOTH
#         if not t["counted_C"] and prevC * curC < 0:
#             count_C += 1
#             t["counted_C"] = True
...
#         t["last_pos"] = c
#         t["last_seen"] = frame_idx
#         t["sideA"], t["sideB"], t["sideC"] = curA, curB, curC
...
#     cv2.line(frame, *LINE_A, (255,0,0), 2)
#     cv2.line(frame, *LINE_B, (0,0,255), 2)
#     cv2.line(frame, *LINE_C, (0,255,255), 2)

#     cv2.putText(frame, f"Line A (OUT): {count_A}", (30,40), 0, 1, (255,0,0), 2)
#     cv2.putText(frame, f"Line B (IN): {count_B}", (30,80), 0, 1, (0,0,255), 2)
#     cv2.putText(frame, f"Line C (BI): {count_C}", (30,120), 0, 1, (0,255,255), 2)
#     cv2.putText(frame, f"Total: {count_A+count_C+count_B}", (30,160), 0, 1, (0,255,255), 2)
